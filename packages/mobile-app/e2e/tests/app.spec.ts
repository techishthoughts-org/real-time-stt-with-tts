...
test.describe('Gon Voice Assistant App - E2E Tests', () => {
  ...
  test.describe('Settings and Configuration', () => {
    ...
    test('should change voice settings', async ({ page }) => {
      ...
      // Change voice speed
      await page.click('[data-testid="voice-speed-slider"]');
      await page.keyboard.press('ArrowRight');
      
      // Change voice pitch
      await page.click('[data-testid="voice-pitch-slider"]');
      await page.keyboard.press('ArrowRight');
    ...
    test('should toggle dark mode', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="app-container"]')).not.toHaveClass(/dark/);
    });
  ...
  test.describe('Accessibility Tests', () => {
    ...
    test('should support keyboard navigation', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="voice-record-button"]')).toBeFocused();
    });
